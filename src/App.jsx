...
class App extends Component {
  ...
  handleSearch = (keyWord) => {
    ...
    let filteredSong = this.state.songs.filter(function (song) {
      if (
        song.title.toLowerCase() === keyWord.toLowerCase() ||
        song.album.toLowerCase() === keyWord.toLowerCase() ||
        song.artist.toLowerCase() === keyWord.toLowerCase() ||
        song.genre.toLowerCase() === keyWord.toLowerCase() ||
        song.release_date.toString().toLowerCase() == keyWord.toLowerCase()
      ) {
        finalList.push(song);
      }
    });
